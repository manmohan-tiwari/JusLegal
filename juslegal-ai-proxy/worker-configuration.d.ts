...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGIN" | "FIREBASE_PROJECT_ID" | "GROQ_API_KEY" | "OPENROUTER_API_KEY">> {}
}
