...
class _ComplaintGeneratorScreenState
  ...
  void _download() async {
    ...
    try {
      ...
      // Use the existing storage_service to store an indication of the download
      await prefs.setString('last_downloaded_letter', _letterController.text.length.toString());
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: Text('Failed to download PDF: ${e.toString()}', style: const TextStyle(color: Colors.white)),
          ),
        );
      }
    } finally {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            parsedAuthority,
                            style: const TextStyle(color: Color(0xFF1F2937), fontSize: 14, fontWeight: FontWeight.w400),
                          ),
                          const SizedBox(height: 12),
                          Row(
                      ...
                      children: [
                        Align(
                          ...
                          child: TextButton.icon(
                            ...
                            label: Text(
                                _isEditing ? 'Lock Letter' : 'Edit Letter'),
                          ),
                        ),
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: (_isGenerating || _isDownloading) ? null : () {
                      HapticFeedback.lightImpact();
                      _download();
                    },
                            ...
                            child: ClipRRect(
                              ...
                              child: LinearProgressIndicator(
                                valueColor: AlwaysStoppedAnimation(Color(0xFF0052CC)),
                                  backgroundColor: Color(0xFF0052CC).withValues(alpha: 0.15),
                              ),
                            ),
                          )
                ...
                IconButton(
                  onPressed:
                      _isGenerating || _letterController.text.isEmpty
                          ? null
                          : () {
                              HapticFeedback.lightImpact();
                              final letterContent =
